...
class Iphone14TwentythreeScreen
    extends GetWidget<Iphone14TwentythreeController> {
  @override
                      ...
                      Expanded(
                          child: SingleChildScrollView(
                            ...
                            Padding(
                                ...
                                child: Text("msg_what_s_on_your_mind".tr,
                                    overflow: TextOverflow.ellipsis,
                                    textAlign: TextAlign.left,
                                    style: AppStyle.txtSoraSemiBold1787)),
                            Padding(
                                padding: getPadding(top: 5),
                                child: Text("msg_search_by_mood".tr,
                                    overflow: TextOverflow.ellipsis,
                                    textAlign: TextAlign.left,
                                    style: AppStyle.txtSoraRegular1228)),
                            CustomImageView(
                                imagePath: ImageConstant.imgEllipse1412,
